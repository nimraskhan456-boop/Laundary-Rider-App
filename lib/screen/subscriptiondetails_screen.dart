                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(
                                "$CurrencyController${preScriptionControllre.preDetailsInfo?.orderProductList.orderTotal}",
                                style: TextStyle(
                                  fontFamily: FontFamily.gilroyBold,
                                  color: BlackColor,
                                  fontSize: 18,
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${CurrencyController}${preScriptionControllre.preDetailsInfo?.orderProductList.orderProductData[preScriptionControllre.currentIndex].productPrice}",
                                        style: TextStyle(
                                          fontFamily: FontFamily.gilroyBold,
                                          fontSize: 14,
                                          color: Colors.grey,
                                ...
                                Expanded(
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${CurrencyController}${preScriptionControllre.preDetailsInfo?.orderProductList.orderProductData[preScriptionControllre.currentIndex].productTotal}",
                                        style: TextStyle(
                                          fontFamily: FontFamily.gilroyBold,
                                          fontSize: 14,
                                          color: Colors.grey,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            OrderInfo(
                              title: "Subtotal".tr,
                              subtitle:
                                  "${CurrencyController}${preScriptionControllre.preDetailsInfo?.orderProductList.orderSubTotal}",
                            ),
                            SizedBox(
                              height: 13,
                            ),
                            OrderInfo(
                              ...
                              subtitle:
                                  "${CurrencyController}${preScriptionControllre.preDetailsInfo?.orderProductList.deliveryCharge}",
                            ),
                            SizedBox(
                              height: 13,
                            ),
                            OrderInfo(
                              ...
                              subtitle:
                                  "${CurrencyController}${preScriptionControllre.preDetailsInfo?.orderProductList.storeCharge}",
                            ),
                            ...
                            preScriptionControllre.preDetailsInfo
                                ...
                                ? OrderInfo(
                                    ...
                                    subtitle:
                                        "${CurrencyController}${preScriptionControllre.preDetailsInfo?.orderProductList.couponAmount}",
                                  )
                                : SizedBox(),
                            SizedBox(
                              height: 13,
